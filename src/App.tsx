  ...
  return <div className="site-shell">
    ...
    <main>
      <section className="hero-section" id="home">
        <div className="hero-copy"><div className="eyebrow"><span/> Trusted care in Surat</div><h1>Thoughtful care.<br/><em>Trusted experience.</em></h1><p className="hero-lead">For over 35 years, Dr. Shaunak Mehta has helped families feel better with accurate diagnosis, clear guidance, and compassionate care.</p><div className="hero-actions"><a href="#contact" className="button primary">Book an Appointment <Icon name="arrow" size={18}/></a><a href="#clinic" className="button secondary"><Icon name="pin" size={18}/> Visit the Clinic</a></div><div className="hero-trust"><div className="avatars"><span>SM</span><span>35+</span><span>MD</span></div><p><strong>4.8/5 patient rating</strong><br/>Trusted by generations of families</p></div></div>
        <div className="hero-visual" aria-label="Medical coat and stethoscope illustration">
          <div className="portrait-card">
            <div className="portrait-bg"/>
            <svg className="coat-art" viewBox="0 0 360 410" role="img" aria-hidden="true">
              <defs><linearGradient id="coatShade" x1="0" x2="1"><stop stopColor="#fff"/><stop offset="1" stopColor="#e8eef5"/></linearGradient><filter id="coatShadow"><feDropShadow dx="0" dy="12" stdDeviation="14" floodColor="#112d4e" floodOpacity=".18"/></filter></defs>
              <g filter="url(#coatShadow)">
                <path fill="#7799bb" d="M132 54h96l20 56-19 250h-98l-19-250z"/>
                <path fill="url(#coatShade)" d="M119 51 55 78c-24 10-34 34-38 68L4 371h154l12-204z"/>
                <path fill="url(#coatShade)" d="m241 51 64 27c24 10 34 34 38 68l13 225H202l-12-204z"/>
                <path fill="#f8fafc" stroke="#cbd6e2" strokeWidth="3" d="m119 51 51 116-61-45-22-51zM241 51l-51 116 61-45 22-51z"/>
                <path fill="none" stroke="#c5d1de" strokeWidth="3" d="m170 167-12 204M190 167l12 204"/>
                <path fill="#dbe4ee" d="M49 238h79v55H49zM232 238h79v55h-79z"/>
                <path fill="none" stroke="#b8c7d6" strokeWidth="3" d="M49 238h79M232 238h79"/>
                <g fill="#7694b3"><circle cx="180" cy="218" r="4"/><circle cx="180" cy="254" r="4"/><circle cx="180" cy="290" r="4"/></g>
              </g>
              <g fill="none" stroke="#243b53" strokeLinecap="round" strokeLinejoin="round">
                <path strokeWidth="8" d="M123 83v62c0 46 25 74 57 74s57-28 57-74V83"/>
                <path strokeWidth="5" d="M180 219v42c0 31 19 52 47 52 24 0 41-14 44-36"/>
                <circle cx="272" cy="264" r="15" fill="#f4f7fa" strokeWidth="7"/>
                <circle cx="272" cy="264" r="4" fill="#3f72af" stroke="none"/>
              </g>
              <circle cx="123" cy="82" r="8" fill="#3f72af"/><circle cx="237" cy="82" r="8" fill="#3f72af"/>
              <path fill="#fff" stroke="#c5d1de" strokeWidth="3" d="M249 151h58v39h-58z"/><path fill="#3f72af" d="M269 159h18v5h-18zM275.5 152.5h5v18h-5z"/>
            </svg>
            <div className="availability"><span className="pulse-dot"/><div><strong>Available Mon–Fri</strong><small>5:00 PM – 7:00 PM</small></div></div>
          </div>
          <div className="experience-badge"><strong>35+</strong><span>Years of<br/>Experience</span></div>
        </div>
      </section>
      <section className="credentials" aria-label="Credentials">{[["award","QUALIFICATION","MD, General Medicine"],["stethoscope","EXPERIENCE","35+ Years in Practice"],["check","REGISTRATION","GMC · G-16424"],["pin","LOCATION","Surat, Gujarat"]].map(([icon,label,value])=><div key={label}><span className="credential-icon"><Icon name={icon}/></span><p><small>{label}</small><strong>{value}</strong></p></div>)}</section>
      <section className="section about" id="about"><div className="section-kicker">About the doctor</div><div className="about-grid"><h2>A lifetime dedicated to<br/><em>better health.</em></h2><div className="about-content"><p className="large-copy">Dr. Shaunak Mehta is a well-established General Physician who has been serving families across Surat for over three decades.</p><p>Known for his patient, approachable manner and clear communication, Dr. Mehta treats a broad spectrum of common and chronic conditions—helping patients of all ages get back on their feet with practical, no-nonsense care.</p><div className="education-list"><div><span>1990</span><p><strong>MD – General Medicine</strong><small>Government Medical College, Surat</small></p></div><div><span>1987</span><p><strong>MBBS</strong><small>Government Medical College, Surat</small></p></div></div></div></div></section>
      ...
      <section className="clinic-section" id="clinic"><div className="clinic-map"><iframe title="Google Map showing Surat" src="https://maps.google.com/maps?hl=en&q=Surat%2C%20Gujarat&z=13&ie=UTF8&iwloc=B&output=embed" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen/><div className="map-address"><span><Icon name="pin" size={18}/></span><p><strong>Dr. Shaunak Mehta's Clinic</strong><small>Nanpura, Surat, Gujarat</small></p></div></div><div className="clinic-info"><div className="section-kicker light">Plan your visit</div><h2>Your trusted clinic<br/>in <em>Nanpura, Surat.</em></h2><div className="clinic-row"><Icon name="pin"/><p><small>LOCATION</small><strong>Nanpura, Surat, Gujarat</strong></p></div><div className="clinic-row"><Icon name="clock"/><p><small>CLINIC HOURS</small><strong>Monday – Friday · 5:00 PM – 7:00 PM</strong><span>Saturday & Sunday · Closed</span></p></div><div className="clinic-note"><Icon name="calendar" size={18}/><p>Please book an appointment before visiting the Nanpura clinic so the team can confirm your slot and keep your wait short.</p></div><div className="clinic-buttons"><a className="button light-button" target="_blank" rel="noreferrer" href="https://www.google.com/maps/search/?api=1&query=Surat+Gujarat">View on Maps <Icon name="arrow" size={18}/></a><a className="text-link" href="#contact">Contact clinic</a></div></div></section>
    ...
    <footer className="footer"><div className="footer-top"><a href="#home" className="brand footer-brand"><span className="brand-mark"><Icon name="stethoscope" size={25}/></span><span><strong>Dr. Shaunak Mehta</strong><small>General Physician · Surat</small></span></a><div className="footer-links">{navItems.slice(0,3).map(([label,href])=><a key={href} href={href}>{label}</a>)}<a href="#contact">Contact</a></div></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Dr. Shaunak Mehta. All rights reserved.</span><span>Developed by <a href="https://shivantra.com/" target="_blank" rel="noreferrer"><strong>Shivantra</strong></a></span></div></footer>
  </div>
}
export default App
