...
function App() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section className="clinic-section" id="clinic"><div className="clinic-map"><iframe title="Google Map showing Surat" src="https://maps.google.com/maps?hl=en&q=Surat%2C%20Gujarat&z=13&ie=UTF8&iwloc=B&output=embed" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen/><div className="map-address"><span><Icon name="pin" size={18}/></span><p><strong>Dr. Shaunak Mehta's Clinic</strong><small>Surat, Gujarat</small></p></div></div><div className="clinic-info"><div className="section-kicker light">Plan your visit</div><h2>Your trusted clinic<br/>in <em>Surat.</em></h2><div className="clinic-row"><Icon name="pin"/><p><small>LOCATION</small><strong>Surat, Gujarat</strong></p></div><div className="clinic-row"><Icon name="clock"/><p><small>CLINIC HOURS</small><strong>Monday – Friday · 5:00 PM – 7:00 PM</strong><span>Saturday & Sunday · Closed</span></p></div><div className="clinic-buttons"><a className="button light-button" target="_blank" rel="noreferrer" href="https://www.google.com/maps/search/?api=1&query=Surat+Gujarat">View on Maps <Icon name="arrow" size={18}/></a><a className="text-link" href="#contact">Contact clinic</a></div></div></section>
